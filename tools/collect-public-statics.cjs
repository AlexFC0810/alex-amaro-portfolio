// One-time import of the six unique static files observed in the owner's
// existing public reference. Preserve native sizes and public-safe metadata.
...
(async()=>{
 ...
 const definitions=[
  {id:'home-services-offer',sourcePath:'/library/home/clarity-door-02.webp',title:'Offer-first door hanger',alt:'Residential cleaning direct-mail design with a clear introductory offer',category:'home',market:'Residential cleaning',provenance:'Own-brand · Direct mail'},
  {id:'home-services-detail',sourcePath:'/library/home/clarity-door-08.webp',title:'Make the service easy to understand',alt:'Residential cleaning door hanger with service details and a contact action',category:'home',market:'Residential cleaning',provenance:'Own-brand · Direct mail'},
  {id:'home-services-trust',sourcePath:'/library/home/clarity-door-04.webp',title:'Benefits and trust, on the reverse',alt:'Reverse side of a residential cleaning door hanger',category:'home',market:'Residential cleaning',provenance:'Own-brand · Direct mail'},
  {id:'home-services-blue',sourcePath:'/library/home/clarity-door-07.webp',title:'A different treatment of the offer',alt:'Blue residential cleaning direct-mail offer design',category:'home',market:'Residential cleaning',provenance:'Own-brand · Direct mail'},
 ...
 m.referenceStaticReview={date:'2026-09-04',normalized:true,uniqueStaticFiles:definitions.length,note:'Native-size public reference assets, not new high-resolution Canva exports. Narrow direct-mail artwork retains its original aspect ratio.',receipts};
